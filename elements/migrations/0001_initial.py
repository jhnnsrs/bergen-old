...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('store', larvik.fields.StoreFileField(blank=True, help_text='The location of the Array on the Storage', null=True, storage=larvik.storage.local.ZarrStorage(), upload_to='', verbose_name='store')),
